## Tools Used
- Visual Studio with Anaconda Extension
- Jupyter Notebook
...
## Instructions
1. Open `main.ipynb` in Jupyter Notebook or Visual Studio with Anaconda Extension.
2. Run each block from top to bottom.
